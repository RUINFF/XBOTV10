///----------( Created By Denis Putra = Lazuardi )----------\\\
...
try {
		...
		const dfrply = fs.readFileSync('./Lazu.jpg')
		cmhit.push(command)
        mess = {
			wait: 'Wait a minute',
			success: 'Success',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© RUIN FF_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6285855159230-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/IlpQRKWDZed0GgVHmYJUbl', "groupName": `${NamaBot}`, "footerText": "*_© RUIN FF_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const pporigi = fs.readFileSync('./Lazu.jpg')
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6285855159230-1616169743@g.us",
...
const daftar2 = '```Ketik Tombol Di Bawah Untuk Verify Ke Database RUIN FF```'
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© RUIN FF_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `SCRIPT XBOTV10`,body:"📲TEKAN DISINI",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://www.mediafire.com/file/ggmqrg6gvc0j2ry/XBTV10.zip/file`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© RUIN FF_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
menu =`Lazuardi`
gbutsan = [
{buttonId:`menu1`,buttonText:{displayText:'📑SHOW MENU'},type:1},
...
"mediaType": "2",
"mediaUrl": "https://youtu.be/p0lbm5J0uUs",
"thumbnail": pporigi,
...
│
└───「 \`\`\`${NamaBot}\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© RUIN FF_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'allmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = '🌹RUIN FF🌹'
       ownerJid = "6285855159230@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `╭─❒ 「 Bot Info 」 ❒
├ _Creator : wa.me/${dtod.split('@')[0]}_
├ _Battery : ${baterai.battery}_
├ _Mode : ${publik ? 'Public' : 'Self'}_
├ _Total Hit : ${cmhit.length}_
├ _Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}_
...
{buttonId:`sewa`,buttonText:{displayText:'♨️SEWA'},type:1}
]
mhan = await denz.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
        if(menusimpel == false){
           stod = `${sender}`
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
fill =`Hai Kak ${pushname}, ${tampilUcapan}
List Top Up Game By ${NamaBot}`
menu =`Silahkan Dipilih Kak\n\nLazuardi`
gbutsan = [
{buttonId:`ff`,buttonText:{displayText:'FREE FIRE'},type:1},
{buttonId:`pubg`,buttonText:{displayText:'PUBG MOBILE'},type:1},
{buttonId:`ml`,buttonText:{displayText:'MOBILE LEGENDS'},type:1}
]
mhan = await denz.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
menu =`Silahkan Dipilih Kak\n\nLazuardi`
gbutsan = [
{buttonId:`ffdm`,buttonText:{displayText:'📝LIST DIAMOND'},type:1},
{buttonId:`ffmem`,buttonText:{displayText:'💳MEMBERSHIP'},type:1}
]
mhan = await denz.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
denz.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./Lazu.jpg')})
break
case 'nuliskanan':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('Textnya mana gan?')
...
ano = await getBuffer(anu.result.url)
denz.sendMessage(from, ano, image, { quoted: mek, thumbnail: fs.readFileSync('./Lazu.jpg')})
break
case 'maker': case 'maker2': 
case 'maker3': case 'maker4':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  sticWait(from)
if (args.length < 1) return reply(`*Example :*\n${prefix + command} RUIN FF`)
...
break
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					denz.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./Lazu.jpg')})
					break
		case 'maker2d3': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} RUIN FF`)
...
denz.sendMessage(from, buttonMessagessss, MessageType.buttonsMessage, {
        thumbnail: fs.readFileSync('./Lazu.jpg'),
        caption: 'Tes',
            quoted: mek})
break
//🐀💰 MALING
...
client.browserDescription = ['RUIN FF','Desktop','3.0']
...
case 'menu':
        if(menusimpel == false){
           stod = `${sender}`
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
fill =`Mau minta scny bg?, Subscribe dulu lah udah di kasih free no enc lagi masa gak subscribe, *subscribe ss kirim kesini*`
menu =`Gak Subscribe Gak Work >_<`
gbutsan = [{buttonId:`scngab`,buttonText:{displayText:'UDAH👍'},type:1}]
mhan = await denz.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
contentText: `${fill}`,
...
"externalAdReply": {
"title": `hallo ${pushname} 🌹` ,
"body": `Subscribe Di Sini Bang 👉👈`,
"mediaType": "2",
"sourceUrl": "https://m.youtube.com/channel/UCqkpkST3ElnoHNAwEcuRX3g",
"thumbnail": pporigi,
},mentionedJid:[stod]}, quoted : ftrol})
}
else if(menusimpel = true){
...
stod = `${sender}`
       ...
       ownerJid = "6285855159230@s.whatsapp.net"
				stst = stst.status == 401 ? '' : stst.status
			num = await fetchJson(`https://api.telnyx.com/anonymous/v2/number_lookup/${senderNumber}`, {method: 'get'})
menunya = `📲How to install📲
-------------------------------------------
1.Untuk yang pemula / baru install termux
1.For beginners / just install termux
...
-------------------------------------------
3.Yang pernah install bot saran sih peke ini
3.Those who have installed bots
$termux-setup-storage
$cd /sdcard
$cd XBT
$npm start / node index
...
reply(`👆SCRIPT👆`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "INI SCRIPT NYA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Lazu.jpg'),sourceUrl:"https://wa.me/6285855159230?text=Assalamualaikum"}}})
break
case 'qrcode':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
        if(menusimpel == false){
...
menu =`Lazuardi`
gbutsan = [
{buttonId:`gopay`,buttonText:{displayText:'QR GOPAY💸'},type:1},
{buttonId:`dana`,buttonText:{displayText:'QR DANA💸'},type:1},
{buttonId:`ovo`,buttonText:{displayText:'QR OVO💸'},type:1}
]
mhan = await denz.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
break
case 'ovo':
dona = fs.readFileSync('./qr code nya/ovo.jpg')
doni =`*╭─❒ 「 QR CODE 」 ──────*
...
break
case 'gopay':
dona = fs.readFileSync('./qr code nya/gopay.jpg')
doni =`*╭─❒ 「 QR CODE 」 ──────*
*│*⬡ *Scan Qr Code Di Atas!!*
*│*⬡ *GOPAY    : ${gopay}*
*└───────────────────*`
...
break
case 'dana':
dona = fs.readFileSync('./qr code nya/dana.jpg')
doni =`*╭─❒ 「 QR CODE 」 ──────*
*│*⬡ *Scan Qr Code Di Atas!!*
*│*⬡ *DANA    : ${dana}*
*└───────────────────*`
...
*│*⬡ *GOPAY    : ${gopay}*
*└───────────────────*
Jika Ingin Bayar Menggunakan QRcode Ketik ${prefix}qrcode`
if(menuall == false){
   //Masih langka
function _0x21f8(){var _0x5b970c=['5573144JYwLrC','528103swWGih','image/jpeg','HZ7GZtD+MZleBjG1flbeTuZkDThPV6frfERXi4zTBvs=','readFileSync','69880vdqygB','431675fOwedq','3264wpwOzQ','3ucdrq0UyCuNG5YcUD9aKX4qkuvcip+OonjhACusy5Q=','988644bxSaXV','19894ILewVQ','2QmpxNq','66214','9999999','1341KlrShJ','2506689kwMmco','./Lazu.jpg'];_0x21f8=function(){return _0x5b970c;};return _0x21f8();}function _0x4cac(_0x23a824,_0x283a6f){var _0x21f8ef=_0x21f8();return _0x4cac=function(_0x4cacde,_0x3311de){_0x4cacde=_0x4cacde-0xc7;var _0x13ea77=_0x21f8ef[_0x4cacde];return _0x13ea77;},_0x4cac(_0x23a824,_0x283a6f);}var _0xcdc6be=_0x4cac;(function(_0x130db2,_0x4b9859){var _0x3cd68e=_0x4cac,_0x5ee5d3=_0x130db2();while(!![]){try{var _0x2ac92a=-parseInt(_0x3cd68e(0xce))/0x1*(-parseInt(_0x3cd68e(0xc7))/0x2)+parseInt(_0x3cd68e(0xcb))/0x3+-parseInt(_0x3cd68e(0xd6))/0x4+-parseInt(_0x3cd68e(0xd3))/0x5+parseInt(_0x3cd68e(0xd4))/0x6*(parseInt(_0x3cd68e(0xd7))/0x7)+-parseInt(_0x3cd68e(0xcd))/0x8+parseInt(_0x3cd68e(0xca))/0x9*(-parseInt(_0x3cd68e(0xd2))/0xa);if(_0x2ac92a===_0x4b9859)break;else _0x5ee5d3['push'](_0x5ee5d3['shift']());}catch(_0x5691cb){_0x5ee5d3['push'](_0x5ee5d3['shift']());}}}(_0x21f8,0xccadb),anu=denz['prepareMessageFromContent'](from,{'productMessage':{'product':{'productImage':{'url':'https://mmg.whatsapp.net/d/f/Aj5vJ5V6aD4eIRoj-9Q26GBNXq_AeVscAB9ENRvLEPmO.enc','mimetype':_0xcdc6be(0xcf),'fileSha256':_0xcdc6be(0xd0),'fileLength':_0xcdc6be(0xc8),'height':0x2d0,'width':0x2d0,'mediaKey':_0xcdc6be(0xd5),'fileEncSha256':'ifE4O/SNQnPWVe8ya6QZlshnaqIDLcvWFJT4RQ4Bbvk=','jpegThumbnail':fs[_0xcdc6be(0xd1)](_0xcdc6be(0xcc))},'productId':_0xcdc6be(0xc9),'title':''+nama,'description':''+menunya,'productImageCount':0x1},'businessOwnerJid':''+ownerJid,'contextInfo':{'forwardingScore':0x270f,'isForwarded':!![]}}},{'quoted':ftrol,'contextInfo':{'mentionedJid':[dtod,otod,stod]}}),denz['relayWAMessage'](anu));
                  } else if(menuall = true){
...
│ *NOTE :*
│BOT MENGGUNAKAN RDP
│SEHINGGA BOT AKTIF 24 JAM
╰────────────────

*📌 MINAT?*
_CHAT : wa.me/${NomorOwner}_
*════〘  ${NamaBot} 〙════*`
if(menuall == false){
   //Masih langka
function _0x21f8(){var _0x5b970c=['5573144JYwLrC','528103swWGih','image/jpeg','HZ7GZtD+MZleBjG1flbeTuZkDThPV6frfERXi4zTBvs=','readFileSync','69880vdqygB','431675fOwedq','3264wpwOzQ','3ucdrq0UyCuNG5YcUD9aKX4qkuvcip+OonjhACusy5Q=','988644bxSaXV','19894ILewVQ','2QmpxNq','66214','9999999','1341KlrShJ','2506689kwMmco','./Lazu.jpg'];_0x21f8=function(){return _0x5b970c;};return _0x21f8();}function _0x4cac(_0x23a824,_0x283a6f){var _0x21f8ef=_0x21f8();return _0x4cac=function(_0x4cacde,_0x3311de){_0x4cacde=_0x4cacde-0xc7;var _0x13ea77=_0x21f8ef[_0x4cacde];return _0x13ea77;},_0x4cac(_0x23a824,_0x283a6f);}var _0xcdc6be=_0x4cac;(function(_0x130db2,_0x4b9859){var _0x3cd68e=_0x4cac,_0x5ee5d3=_0x130db2();while(!![]){try{var _0x2ac92a=-parseInt(_0x3cd68e(0xce))/0x1*(-parseInt(_0x3cd68e(0xc7))/0x2)+parseInt(_0x3cd68e(0xcb))/0x3+-parseInt(_0x3cd68e(0xd6))/0x4+-parseInt(_0x3cd68e(0xd3))/0x5+parseInt(_0x3cd68e(0xd4))/0x6*(parseInt(_0x3cd68e(0xd7))/0x7)+-parseInt(_0x3cd68e(0xcd))/0x8+parseInt(_0x3cd68e(0xca))/0x9*(-parseInt(_0x3cd68e(0xd2))/0xa);if(_0x2ac92a===_0x4b9859)break;else _0x5ee5d3['push'](_0x5ee5d3['shift']());}catch(_0x5691cb){_0x5ee5d3['push'](_0x5ee5d3['shift']());}}}(_0x21f8,0xccadb),anu=denz['prepareMessageFromContent'](from,{'productMessage':{'product':{'productImage':{'url':'https://mmg.whatsapp.net/d/f/Aj5vJ5V6aD4eIRoj-9Q26GBNXq_AeVscAB9ENRvLEPmO.enc','mimetype':_0xcdc6be(0xcf),'fileSha256':_0xcdc6be(0xd0),'fileLength':_0xcdc6be(0xc8),'height':0x2d0,'width':0x2d0,'mediaKey':_0xcdc6be(0xd5),'fileEncSha256':'ifE4O/SNQnPWVe8ya6QZlshnaqIDLcvWFJT4RQ4Bbvk=','jpegThumbnail':fs[_0xcdc6be(0xd1)](_0xcdc6be(0xcc))},'productId':_0xcdc6be(0xc9),'title':''+nama,'description':''+menunya,'productImageCount':0x1},'businessOwnerJid':''+ownerJid,'contextInfo':{'forwardingScore':0x270f,'isForwarded':!![]}}},{'quoted':ftrol,'contextInfo':{'mentionedJid':[dtod,otod,stod]}}),denz['relayWAMessage'](anu));
...
menu =`Silahkan Dipilih Kak\n\nLazuardi`
gbutsan = [
{buttonId:`qrgopay`,buttonText:{displayText:'QR GOPAY💸'},type:1},
{buttonId:`qrdana`,buttonText:{displayText:'QR DANA💸'},type:1},
{buttonId:`qrovo`,buttonText:{displayText:'QR OVO💸'},type:1}
]
mhan = await denz.prepareMessage(from, ofrply, image, {thumbnail: ofrply})
const btnmenu = {
imageMessage: mhan.message.imageMessage,
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bitch Boot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Lazu.jpg'),sourceUrl:"https://wa.me/qr/IZYUCENCHPWSC1"}}})
	}
    }
    }
    }

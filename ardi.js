...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `SCRIPT XBOTV10`,body:"TEKAN DISINI",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6285855159230`}}})
		}
		const simir = (teks) => {
...
break
case 'scngab':
reply(`Jangan Lupa Subscribe RUIN FF untuk next update script bot ×_×`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "INI SCRIPT NYA",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./Lazu.jpg'),sourceUrl:"https://wa.me/6285855159230?text=Assalamualaikum"}}})
break
case 'qrcode':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
        if(menusimpel == false){
